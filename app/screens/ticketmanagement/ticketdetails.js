...
getServiceBoyRow(assigneedetails){
 return ( <View style={[styles.tileWrapper,{width:"90%"}]}>
   ...
   <Text style={[globalStyles.labelText,{color:"black"}]}> {assigneedetails.name} </Text>
   <Text style={{}}> - {assigneedetails.mobileno} </Text>
    ...
    alignContent:"center",}}
    >
      <View style={[globalStyles.separator,{marginVertical:1}]} />
      </View>
    </View>
 )
}
